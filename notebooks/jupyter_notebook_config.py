...
# Allow long-running code cells (default is 30 minutes)
c.NotebookApp.iopub_data_rate_limit = 100000000  # Increase data rate limit
c.NotebookApp.iopub_msg_rate_limit = 1000000      # Increase message rate limit
c.NotebookApp.time_limit = 3600  # Set a longer time limit in seconds

c.IPKernelApp.nthreads = 4  # Number of threads to be used by the kernel

c.ServerApp.max_buffer_size = 2147483648  # Set max buffer size to 2GB in bytes
